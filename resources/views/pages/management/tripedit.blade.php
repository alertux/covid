...
<div class="kt-portlet">
    ...
    <!--begin::Form-->
    <form role="form" id="edit-place-form" method="post" enctype="multipart/form-data" class="kt-form kt-form--label-right" action="{{ route('trip.update', $place->id) }}">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
        <div class="kt-portlet__body">
            ...
            <div class="form-group row">
                <label for="visit_at" class="col-3 col-form-label">Visitar Fecha</label>
                <div class="col-7">
                    <div class="input-daterange input-group" id="trip_datepicker">
                        <input type="text" class="form-control" readonly name="visit_at" value="{{ old('visit_at', $place->visit_at) }}" />
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                        </div>
                        <input type="text" class="form-control" readonly name="end_at" value="{{ old('end_at', $place->end_at) }}"/>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <label for="place_name" class="col-3 col-form-label">Tripped Place</label>
                <div class="col-7">
            ...
            <div class="form-group row">
                <label for="persons" class="col-3 col-form-label">Persons</label>
                <div class="col-7">
